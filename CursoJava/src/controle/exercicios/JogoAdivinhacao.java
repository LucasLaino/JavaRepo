...
public class JogoAdivinhacao {
	 ...
	 /**
	  * Jogo da adivinhação: Tenta adivinhar um número entre 0 e 100 e armazena
	  * um número aleatório em uma variável. O Jogador tem 10 tentativas para
	  * adivinhar o número gerado. Ao final de cada tentativa, imprime a quantidade
	  * de tentativas restantes, e se o número inserido é maior ou menor do
